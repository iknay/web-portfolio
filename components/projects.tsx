...
function Projects({}: Props) {
  return (
    ...
    className='flex flex-col items-center h-screen max-w-full px-10 mx-auto overflow-hidden text-left md:flex-row justify-evenly text-paper '>
        <h3 className='absolute top-24 tracking-[15px] text-2xl'>projects</h3>

        <div className='flex w-full mt-16 space-x-5 overflow-x-scroll xl:mt-24 snap-x '>
          <ProjectsCard/>
          <ProjectsCard/>
          <ProjectsCard/>
          <ProjectsCard/>
