  ...
  return (
    <div className="w-full h-screen">
      ...
      <div className="lg:flex h-[90%] grid items-end">
        <h1 className=" xl:text-[238px] lg:text-[220px] md:text-5xl text-3xl leading-none text-secondary font-rubik font-medium">
          Front End Developer
        </h1>
        <div>
          {/* <p>specializing in front-end development</p> */}
          <a
            href="https://drive.google.com/file/d/1CIG8YLyGin37UOjgxu246QFbYFjNVLJr/view?usp=sharing"
            target="_blank"
            rel="noreferrer noopener"
          >
            <button className="button px-10 py-1 border-2 rounded-full border-primary text-[40px] text-primary mt-4 mb-10">
              resume
            </button>
          </a>
        </div>
